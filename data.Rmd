...
fix_metadata <- function(data) {
  ...
  #extract periods
  data$metadata$Period <- ifelse (dates >= WS | dates < SE, "Winter", #winter
...
#digester archaea (LATEST, USE THIS)
```{r}
metadata <- openxlsx::read.xlsx("data/[2018-12-3] data/midad/Archaea 2011-2018(Q2)/metadata_midad_archaea.xlsx", detectDates = TRUE)
otutable <- data.table::fread("data/[2018-12-3] data/midad/Archaea 2011-2018(Q2)/otutable.txt", fill = TRUE)
...
```{r}
metadata <- openxlsx::read.xlsx("data/[2018-12-3] data/midad/Bacteria 2011-2018 (Q2)/metadata_midad_bacteria.xlsx", sheet = "metadata", detectDates = TRUE)
otutable <- data.table::fread("data/[2018-12-3] data/midad/Bacteria 2011-2018 (Q2)/otutable.txt", fill = TRUE)
...
save(biobank2015_2018, file = "data/biobank2015_2018.rda")
biobank2015_2018_PeriodAvg <- periodAvg(biobank2015_2018$metadata)
save(biobank2015_2018_PeriodAvg, file = "data/biobank2015_2018_PeriodAvg.rda")
```
...
save(AalborgW, file = "data/AalborgW.rda")
...
save(AalborgW_PeriodAvg, file = "data/AalborgW_PeriodAvg.rda")
```
