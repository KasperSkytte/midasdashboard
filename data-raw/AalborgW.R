...
metadata <- openxlsx::read.xlsx("data-raw/amplicon_data/aalborgwest/metadata_BIOBANK_Aalborg_Vest_2.xlsx", detectDates = TRUE)
otutable <- data.table::fread("data-raw/amplicon_data/aalborgwest/otutable.txt", fill = TRUE)
...
##### DSVI #####
AalborgW_DSVI <- openxlsx::read.xlsx("data-raw/amplicon_data/aalborgwest/DSVI_BIOBANK_AalborgVest_2015-2018.xlsx", detectDates = TRUE)
